    ...
    def add_emp(self):
        if (self.user_type == "Admin"):
            ...
            with open('employee_data.json', 'r+') as file:
                ...
                Employee.emp_list.append(temp_dict)
                # file.seek(0)
                json.dump(Employee.emp_list, file, indent=4)
            print("New employee record successfully added")
            ...
            if(obj[i]["user_type"] == "Admin"):
                ...
                if (c == 0):
                    ...
                    if(x == 1):
                        ...
                        obj[Employee.index]["name"] = e_name_up
                    ...
                    # update employee user type
                        ...
                        obj[Employee.index]["user_type"] = e_user_type_up
                    ...
                    # update employee project name
                        ...
                        obj[Employee.index]["project_name"] = e_project_name_up
                    ...
                    # update employee year of experience
                        ...
                        obj[Employee.index]["year_of_exp"] = e_year_of_exp_up
                    ...
                    # update employee skill set
                        ...
                        obj[Employee.index]["skill_sets"] = e_skill_sets_up
                    ...
                    # update employee joining date
                        ...
                        obj[Employee.index]["joining_date"] = e_joining_date_up
                    ...
                    # update employee DOB
                        ...
                        obj[Employee.index]["DOB"] = e_dob_up
                    ...
                    # update employee age
                        ...
                        obj[Employee.index]["age"] = e_age_up
                    ...
                    # update employee phone number
                        ...
                        obj[Employee.index]["phone_number"] = e_phone_number_up
